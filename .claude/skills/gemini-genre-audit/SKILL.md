...
# ジャンル検品 (= トリガー「ジャンル検品して」「Gemini検品して」/ 裁定は「**検品裁定して**」。2026-07-14 ユーザ設計)

★「**検品裁定して**」= 溜まった不一致(`--report`→genre-verify-disagree.tsv)を上位モデルがまとめてレビューし、
下の採用ゲートを通った分だけ適用する合図(運転=Sonnet/裁定=上位モデル、の分業の後半)。

...
- **NO_MATCH(著者有)36,349件 → 著者経由で 3,815件回収可能(10%)**(著者一致 AND 題一致の二重確認)。
- サンプル25件精査 → **精度 ~80%**(正20 / 疑3-5)。 誤りは続編→基底の取り違え
...
### マッチ率の伸びしろ(総括)
- 現状 34,013(44.5%)。 著者経由 +約3,000(精度込) → **~37,000(~48-49%)**。
- DISPLACED 3,298 の一部 + 題正規化改良で さらに上積み余地 → **~50-52% が現実的目標**。

...
description: ギャラ型(巻×発売日の大逆行)是正。検出器 573→36版。残=gyara-anomalies.tsv(reason: 済/正史/未了を追記済)。トリガー「ギャラ型続けて」
metadata: 
  node_type: memory
  type: project
...
**トリガー「ギャラ型続けて」**。全帯一巡(Opus)で 573→130版、仕上げラウンド(Fable 2026-08-17)で ring17全消化→115版、種2外seed起因クラス14件+ムダヅモPoJ新頁分離で→100版、「ISBN消える」クラス33頁+ふくふくNEW新頁分離で→67版、**round3(行内混成+単発日付誤り32頁+新・駅弁新頁)で →36版**(2026-08-17)。残りは全部 **理由つきで台帳**にしてある。

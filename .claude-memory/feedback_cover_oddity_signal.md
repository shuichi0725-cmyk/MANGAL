...
- ★**「発売済のはずなのに仮書影(文字だけの .gif)のまま」= 発売日の延期を疑う**(2026-09-04 すてごろブッチ型)。
  仮書影は発売前に出るものなので、**書影の柱を疑う前に発売日を疑う**のが正しい順序。
  実際この報告は「予約巻の発売日が動いても追随しない」という別の穴の入口だった
  → [[preorder_date_drift_sutegoro_type]]。

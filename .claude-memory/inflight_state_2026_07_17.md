...
## 保留キュー(07-12から引き継ぎ)
- 試し読み保留19,247裁定(2026-07-18バッチ1=1,702採用済み。堅い規則=題完全一致+著者+HEAD200/--accept-file口あり/内訳=候補0が3,531・残は緩め規則or再検索で次バッチ) + 収集続行 / 成年triage871頁目視 / 手塚全集突合E組27冊 / ghost-volumes22頁 / 全集コーナー=収集済み・まとめGO待ち([[zenshuu-corner-state]]) / kobo-gap-skip185作 / FLAG108(genre-other-flags=画集/評論/対談集等)=ユーザ「あとで」

...
## 保留キュー(07-12から引き継ぎ)
- 試し読み裁定=★枯れるまで完了(2026-07-18: 計4,379採用→アンカー18,328。手法=商品頁実取得7,047件で決定的突合+ルール型+目視5スライス636件。残保留16,570=候補0(3,531)+調査済み不一致(2,733台帳)+別作/判別不能系=全て正しい保留。残作業=403の493件再試行と同題2tid判別のみ小粒) + 収集続行 / 成年triage871頁目視 / 手塚全集突合E組27冊 / ghost-volumes22頁 / 全集コーナー=収集済み・まとめGO待ち([[zenshuu-corner-state]]) / kobo-gap-skip185作 / FLAG108(genre-other-flags=画集/評論/対談集等)=ユーザ「あとで」

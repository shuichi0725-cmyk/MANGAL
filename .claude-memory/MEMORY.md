...
- [【型・検出器あり・3段適用済】Sugar&Spice型=巻題を題として別sid登録→末尾巻欠け](subtitle_orphan_volume_split_sugar_spice.md) — _audit-subtitle-orphan-volume.py。2026-09-03 override4頁/別sid195巻62頁/取込もれ643巻413頁を適用。残=subtitle-orphan-volume-review.tsv(レーベル和英alias表で救える)

...
- [【実装済・preview確認待ち】検索フィルターUI改善5点+巻数フィルター](filter_ui_todo_2026_09_05.md) — 6点とも実装+push済。残=preview目視→「機能蒸留して」。巻数の基準=max_edition_volumes(初出版は不採用=105頁で壊れる)・filterItemsで件数153→78ms・内部スクロール全廃

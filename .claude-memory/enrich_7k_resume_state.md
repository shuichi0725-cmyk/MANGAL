...
metadata: 
  ...
  modified: 2026-07-23T07:49:38.789Z
---

キャッチ/詳細の分散エンリッチ(対象7,048作=72バッチ)。2026-07-07にセッション枠問題で一括WFは破棄。

- **完了14バッチ(000-013)= 2026-07-23に本番適用+push済**。000-011(約1,200作)=既生成分(195c1f908)、012+013(各~99作)=Opusインライン生成分。
...
- **残バッチ014-071(~5,800作)= 未生成**。材料は `.cache/enrich-batches/batch-0NN.json`(消えたら `.cache/_prep_enrich_batches.py` 再生成可)。

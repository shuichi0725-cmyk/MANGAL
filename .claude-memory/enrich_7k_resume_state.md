...
description: "キャッチ/詳細エンリッチの進捗と再開点。2026-07-30時点: full系バッチは全消化済。★現在の作業=短キャッチrequeue(batch-0001〜0190)の消化で、0046まで=808作を本番反映済/残3,266作・次はbatch-0047から。genre系0218-0380も実質完了(残121はmaster32該当なし)"
metadata: 
  node_type: memory
  type: project
...
## ★現在の作業 = 短キャッチ requeue の消化(次は batch-0047 から)
...
- **残 = 3,451作(batch-0047〜0190)。次は batch-0047 から**。

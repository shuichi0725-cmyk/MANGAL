...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <p className="mt-2 text-xs text-black/50">最終更新: 2026年4月</p>

      <section className="mt-8 space-y-3 text-sm leading-relaxed text-black/80">
        <h2 className="text-base font-semibold text-black">1. 適用範囲</h2>
        <p>
      ...
      <section className="mt-8 space-y-3 text-sm leading-relaxed text-black/80">
        <h2 className="text-base font-semibold text-black">2. 掲載情報の正確性</h2>
        <p>
      ...
      <section className="mt-8 space-y-3 text-sm leading-relaxed text-black/80">
        <h2 className="text-base font-semibold text-black">3. 著作権・知的財産権</h2>
        <p>
      ...
      <section className="mt-8 space-y-3 text-sm leading-relaxed text-black/80">
        <h2 className="text-base font-semibold text-black">4. リンクについて</h2>
        <p>
      ...
      <section className="mt-8 space-y-3 text-sm leading-relaxed text-black/80">
        <h2 className="text-base font-semibold text-black">5. 免責事項</h2>
        <p>
          本サイトの利用により利用者または第三者に発生した損害について、運営者は一切の責任を負いません。Amazon.co.jp その他外部サイトの利用は、各サイトの利用規約に従ってください。
        </p>
        <p>
          本サイトのアフィリエイトリンクから遷移した先での取引は、すべて当該販売事業者と利用者との間で完結します。本サイトはその取引に関与しません。
        </p>
      </section>

      <section className="mt-8 space-y-3 text-sm leading-relaxed text-black/80">
        <h2 className="text-base font-semibold text-black">6. サイトの変更・停止</h2>
        <p>
      ...
      <section className="mt-8 space-y-3 text-sm leading-relaxed text-black/80">
        <h2 className="text-base font-semibold text-black">7. 規約の変更</h2>
        <p>
      ...
      <section className="mt-8 space-y-3 text-sm leading-relaxed text-black/80">
        <h2 className="text-base font-semibold text-black">8. 準拠法・管轄裁判所</h2>
        <p>

...
export const VolumeSchema = z.object({
  ...
  /** 巻ごとの出版社 (= 版元移管・社名変更で **巻の途中から発行元が変わる**作品。
   *  ★版の publisher と異なる巻にだけ入れる(省略時は版の publisher を使う)。
   *  2026-07-26 ユーザ指摘「発売時期が長いと途中で変わって矛盾するのでは?」。
   *  実測1,672版が該当: 鬼平犯科帳122巻=文藝春秋46+リイド社76 / サザエさん68巻=朝日新聞社→朝日新聞出版 /
   *  静かなるドン54巻=小学館→実業之日本社。 従来は多数決で1社に丸めて片方が消えていた。 */

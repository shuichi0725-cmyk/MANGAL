...
BRAND_DROP_KEYWORDS = [
    ...
    # bilingual / 英訳版 (= ドラえもん 検証で 発見)
    "english", "ENGLISH COMICS",
    # 児童 絵本 (= 小学館のテレビ絵本 / ギンピカシール絵本 等)
    "絵本",
    # 劇場版/映画 コミック (= alternateName で 検出)
    "映画ストーリー", "劇場用アニメ",
]
...
TITLE_DROP_CONTAINS = [
    ...
    "空想科学読本",
    # ドラえもん 検証で 発見
    "学習まんが", "ひみつ道具百科", "映画ストーリー", "深読みガイド",
    # NARUTO + 名探偵コナン 検証で 発見
    "劇場版",  # ← title prefix とは別、 「: 劇場版」 等 contains で 拾う
    "特別編集", "名言集",
    "QUIZ BOOK", "クイズBOOK", "クイズブック",
    "秘伝・",  # NARUTO 公式 guide patterns (= 「秘伝!」 漫画は ・なし)
    "画集", "イラスト全集",
]

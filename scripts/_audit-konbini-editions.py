...
# 2026-08-31 第2波で昇格: Comic魂別冊系(主婦の友社/はちどり 2018-20・652円ムック) /
#   SPポケットワイド(リイド社の廉価ワイド・605-660円) / My first wide(小学館・MFBの姉妹線・682円) /
#   King series 漫画スーパーワイド(小池書院・712円の章題つき廉価復刻)
HIGH = re.compile(
    ...
    r'ヤングジャンプ・コミックスセレクション|My ?First ?BIG.*|マイファーストビッグ.*|'
    r'Comic魂.*|コミック魂.*|はちどり版|'
    r'(SPコミックス[ 　.]*)?SP ?(ポケットワイド|pocket ?wide)|SPコミックス[ 　.]*ポケットワイド|'
    r'My ?first ?wide|マイファーストワイド|(King ?series ?)?漫画スーパーワイド)$', re.I)
...
SETTLED = {
    ...
    # --- 2026-08-31 第2波(網の穴の追補)で裁定 ---
    "ビッグゴールドコミックス": "小学館ビッグコミックスゴールド(1994-98・715円)。雑誌ビッグゴールド作品の"
                     "初出単行本レーベルでコンビニ本ではない",
    "ビッグゴールド・コミックス": "同上(中黒表記ゆれ)",
    "コンパクトコミックス": "集英社の1960年代新書判レーベル(サスケ1966-67/片目猿1968等)=コンビニ本以前の正規版。"
                   "マグマ大使の同名imprintは実体が秋田・手塚治虫傑作選集(1993・1068円)のラベル違いで、これも廉価本ではない",
    "講談社コミックスグランドコレクション": "1989-96・1068〜1281円の書店流通再刊シリーズ。コンビニ帯より高価格。"
                          "★あすなろ坂のこのimprint行は1977-80年のKC原版が合流したラベル違い(中身は正規)",
}
# ★保留(SETTLEDでもHIGHでもない・証拠不足のまま残す): Goma books(2019年の劇画復刻・POD/廉価の別が未確定。
#   子連れ狼8巻/ダミー・オスカー2巻) / セレクト(弐十手1987・小学館) / 道草文庫=文庫641円で正規(触らない)
# 候補として拾うが HIGH でないもの(=人が裁く)。ここに当たらないレーベルは最初から見ない
# ★2026-08-31 見直しで網の穴を追補: My first wide / Comic魂 / ポケットワイド / コンパクトコミックス /
#   グランドコレクション / ビッグゴールド (imprint全走査×コンビニ語彙のスキャンで発見)
CAND = re.compile(
    r'コンビニ|my ?first ?(big|wide)|マイファースト(ビッグ|ワイド)|platinum|プラチナ|remix|リミックス|廉価|'
    r'セレクション|オンデマンド|top ?comics|トップコミックス|kpc|蔵出し|'
    r'ぶんか社コミック文庫|秋田コミックス(セレクト|スペシャル)|'
    r'comic魂|コミック魂|ポケットワイド|コンパクトコミックス|グランドコレクション|ビッグゴールド', re.I)

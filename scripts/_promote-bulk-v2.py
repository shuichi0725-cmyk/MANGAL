...
def build_yml(
    ...
    o["publisher"] = (seed3 or {}).get("publisher") or src_yml.get("publisher", "(unknown)")
    o["magazine"] = (seed3 or {}).get("magazine") or src_yml.get("magazine")
    o["demographic"] = (seed3 or {}).get("demographic") or src_yml.get("demographic", "shounen")
    o["genres"] = (seed3 or {}).get("genres") or src_yml.get("genres", ["other"])
